...
def AddUpdateUser(Emp_ID, Emp_Name, Emp_Grade, Emp_Team, Task_Skills_Req, Emp_Skills):
    try:
        ...
        existsQuery = "INSERT INTO Employee(Emp_ID, Emp_Name, Emp_Grade, Emp_Team, Task_Skills_Req, Emp_Skills) Values ("+str(Emp_ID)+",' "+str(Emp_Name)+" ',' "+str(Emp_Grade)+" ',' "+str(Emp_Team)+" ',' "+str(Task_Skills_Req)+" ',' "+str(Emp_Skills)+" ')"
...
AddUpdateUser(Emp_ID, Emp_Name, Emp_Grade, Emp_Team, Task_Skills_Req, Emp_Skills)
count = 0
